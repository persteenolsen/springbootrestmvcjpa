...
package com.persteenolsen.springbootrestmvcjpa.model;
...
import com.persteenolsen.springbootrestmvcjpa.model.ValidEmail;

// The table in the Database will have a name almost equal to "SpringBootRestMvcJpaPersons"
@Entity
@Table(name = "SpringBootRestMvcJpaPersons")
